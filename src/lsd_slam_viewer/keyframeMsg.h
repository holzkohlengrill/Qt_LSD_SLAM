/* Auto-generated by genmsg_cpp for file /home/adam/ros_ws/lsd_slam/lsd_slam_viewer/msg/keyframeMsg.msg */
...
namespace lsd_slam_viewer
{
  ...
  namespace ros
  {
    ...
    {
      template<class ContainerAllocator> struct IsMessage< ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator> > : public TrueType {};
      template<class ContainerAllocator> struct IsMessage< ::lsd_slam_viewer::keyframeMsg_<ContainerAllocator>  const> : public TrueType {};
      template<class ContainerAllocator>
